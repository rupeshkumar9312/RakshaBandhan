...
import { SITE, RAKHI_BRAND, TRUST_POINTS } from "@/lib/site";
...
export const metadata: Metadata = {
  title: `${RAKHI_BRAND.name} — Raksha Bandhan gifting`,
  description:
...
export default async function RakhiBazaarPage() {
          ...
          <div>
            ...
            <div className="mt-5 space-y-4 text-[0.9375rem] leading-relaxed text-ink-soft">
              <p>
                ...
                by the 5th. We started {RAKHI_BRAND.name} because a festival about showing up
                shouldn&apos;t begin with a traffic jam.
              </p>
              <p>
